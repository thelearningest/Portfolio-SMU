...
export const projects: Project[] = [
  ...
  },
  {
    ...
    type: 'Content',
    description: 'A beginner-friendly Vietnamese guide that makes LLM fundamentals understandable through intuitive examples and careful research—300K+ views.',
  ...
  },
  {
    ...
    category: 'Web app',
    type: 'Coding Project',
    description: 'A customizable Pomodoro workspace that helps learners focus with music, personal backgrounds, and flexible study sessions—used across 4,000 visits.',
